...
namespace PlugY_Configurator_Avalonia.ViewModels
{
    public partial class MainWindowViewModel : ViewModelBase
    {
        ...
        {
            get => _msgBox_Visab;
            set => this.RaiseAndSetIfChanged(ref _msgBox_Visab, value);
        }
        ...
        public bool MsgBox_IconInformation_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_IconInformation_Visab, value);
        }
        ...
        public bool MsgBox_IconGood_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_IconGood_Visab, value);
        }
        ...
        public bool MsgBox_IconError_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_IconError_Visab, value);
        }
        ...
        public bool MsgBox_IconHelp_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_IconHelp_Visab, value);
        }
        ...
        public bool MsgBox_IconWarning_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_IconWarning_Visab, value);
        }

        private GeometryDrawing _msgBox_Icon = new();
        public GeometryDrawing MsgBox_Icon
        {
            get => _msgBox_Icon;
            set => this.RaiseAndSetIfChanged(ref _msgBox_Icon, value);
        }
        ...
        public bool MsgBox_Icon_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_Icon_Visab, value);
        }
        ...
        public bool MsgBox_Title_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_Title_Visab, value);
        }
        ...
        public string MsgBox_Title_Txt
        {
            ...
            set
            {
                ...
                this.RaiseAndSetIfChanged(ref _msgBox_Title_Txt, value);
            }
        }
        ...
        {
            get => msgBox_Txt;
            set => this.RaiseAndSetIfChanged(ref msgBox_Txt, value);
        }
        ...
        public bool MsgBox_TxtBox_Visb
        {
            ...
            set
            {
                ...
                this.RaiseAndSetIfChanged(ref _msgBox_TxtBox_Visb, value);
            }
        }
        ...
        public bool MsgBox_ComboBox_Visab
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_ComboBox_Visab, value);
        }
        ...
        public string MsgBox_Btn1_Txt
        {
            ...
            set
            {
                ...
                this.RaiseAndSetIfChanged(ref _msgBox_Btn1_Txt, value);
            }
        }
        ...
        public string MsgBox_Btn2_Txt
        {
            ...
            set
            {
                ...
                this.RaiseAndSetIfChanged(ref _msgBox_Btn2_Txt, value);
            }
        }
        ...
        public string MsgBox_Btn3_Txt
        {
            ...
            set
            {
                ...
                this.RaiseAndSetIfChanged(ref _msgBox_Btn3_Txt, value);
            }
        }
        /*
        ...
        public double MsgBox_Width
        {
            ...
            {
                //MsgBox_Btn3_Visab = !string.IsNullOrEmpty(value);
                this.RaiseAndSetIfChanged(ref _msgBox_Width, value);
            }
        }*/
        ...
        public SolidColorBrush MsgBox_BackgroundColor
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_BackgroundColor, value);
        }
        ...
        public IBrush MsgBox_BorderColor
        {
            ...
            set => this.RaiseAndSetIfChanged(ref _msgBox_BorderColor, value);
        }
